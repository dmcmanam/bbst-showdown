 ...
 * (delta r is one or two by definition of the rank-balanced AVL tree).
 * 
 ...
 */
public class TreeMapAVLRB<K, V> extends AbstractMap<K, V> {
     ...
     */
    public TreeMapAVLRB(Map<? extends K, ? extends V> m) {
        comparator = null;
        putAll(m);
    }
